...
def improved_partition_graph(g, num_parts, sample_length, out_path, reshuffle, partition_data, xadj, adjncy, eweights, node_part_var, graph_name = 'test',balance_ntypes=None, balance_edges=False, num_hops=1, return_mapping=True):
    # degrees = (g.in_degrees()).tolist()
    # eweights = []
